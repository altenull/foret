...
storiesOf('components/RadioButton', module)
  ...
  .add('radio button', () => ({
    template: `
      <foret-storybook-template>
        <foret-radio-button-group [legendText]="'Radio button'" [checkedValue]="'radioButton2'">
  ...
  .add('disabled radio button', () => ({
    template: `
      <foret-storybook-template>
        <foret-radio-button-group [legendText]="'Radio button'" [checkedValue]="'disabledRadioButton2'" [disabled]="true">
